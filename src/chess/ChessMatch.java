...
public class ChessMatch {
    ...
    public void initialSetup() {
        placeNewPiece('c', 1, new Rook(Color.BLACK, board));
        placeNewPiece('c', 2, new Rook(Color.BLACK, board));
        placeNewPiece('d', 2, new Rook(Color.BLACK, board));
        placeNewPiece('e', 2, new Rook(Color.BLACK, board));
        placeNewPiece('e', 1, new Rook(Color.BLACK, board));
        placeNewPiece('d', 1, new King(Color.BLACK, board));
